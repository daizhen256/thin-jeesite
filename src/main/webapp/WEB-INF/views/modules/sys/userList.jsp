		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="sys:user:edit"><a class="btn btn-primary" href="${ctx}/sys/user/form">添加</a></shiro:hasPermission>
				</td>
			</tr>
		</table>
	</form:form>
		...
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<shiro:hasPermission name="sys:user:edit"><td>
    				<a class="btn btn-sm btn-primary" href="${ctx}/sys/user/form?id=${user.id}">修改</a>
					<a class="btn btn-sm btn-warning" href="${ctx}/sys/user/delete?id=${user.id}" onclick="return confirmx('确认要删除该用户吗？', this.href)">删除</a>
