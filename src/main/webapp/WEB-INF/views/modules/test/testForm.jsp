	...
	<form:form id="inputForm" modelAttribute="test" action="${ctx}/test/test/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<input class="btn" type="button" value="对话框" onclick="top.jQuery.jBox('iframe:${ctxStatic}/jquery-jbox/2.3/docs/jbox-demo.html',{title: '对话框',width: 950,height: 600,buttons: { '关闭': true }});"/>
				<input class="btn" type="button" value="客户端验证" onclick="top.jQuerys.jBox('iframe:${ctxStatic}/jquery-validation/1.11.0/demo/index.html',{title: '客户端验证',width: 950,height: 600,buttons: { '关闭': true }});"/>
			</div>
		</div>
