...
<div class="page-content">
	<form:form id="searchForm" modelAttribute="genTable" action="${ctx}/gen/genTable/" method="post" class="breadcrumb form-search">
		...
		<shiro:hasPermission name="gen:genTable:edit"><a class="btn btn-s-md btn-primary" href="${ctx}/gen/genTable/form">添加</a></shiro:hasPermission>
	</form:form>
		...
		<c:forEach items="${page.list}" var="genTable">
			<tr>
				...
				<shiro:hasPermission name="gen:genTable:edit"><td>
    				<a class="btn btn-sm btn-primary" href="${ctx}/gen/genTable/form?id=${genTable.id}">修改</a>
					<a class="btn btn-sm btn-warning" href="${ctx}/gen/genTable/delete?id=${genTable.id}" onclick="return confirmx('确认要删除该业务表吗？', this.href)">删除</a>
