			...
			<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/save" method="post" class="form-horizontal">
				...
				<fieldset>
					...
					<div class="col-md-2">
						...
						<div class="col-md-10">
						<div class="form-group">
							<form:select path="parentTable" cssClass="input-xlarge" style="width:300px;">
								<form:option value="">无</form:option>
								<form:options items="${tableList}" itemLabel="nameAndComments" itemValue="name" htmlEscape="false"/>
							</form:select>
							&nbsp;当前表外键：
							<form:select path="parentTableFk" cssClass="input-xlarge" style="width:300px;">
								<form:option value="">无</form:option>
						...
						<table id="contentTable" class="table table-striped table-bordered table-condensed">
							...
							<c:forEach items="${genTable.columnList}" var="column" varStatus="vs">
								<tr${column.delFlag eq '1'?' class="error" title="已删除的列，保存之后消失！"':''}>
									...
									<td>
										<select name="columnList[${vs.index}].queryType" class="required input-mini" style="width:100px;">
									...
									<td>
										<input type="text" name="columnList[${vs.index}].sort" value="${column.sort}" maxlength="200" class="required input-min digits" style="width:100px;"/>
									</td>
								</tr>
							</c:forEach>
							</tbody>
