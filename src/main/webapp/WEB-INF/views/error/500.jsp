...
<body>
	<div class="container-fluid">
		...
		<div class="errorMessage">
			...
			<a href="javascript:" class="btn btn-default" onclick="history.go(-1);" class="btn">返回上一页</a> &nbsp;
			<a href="javascript:" class="btn btn-info" onclick="jQuery('.errorMessage').toggle();" class="btn">查看详细信息</a>
		</div>
		<div class="errorMessage" style="display:none;">
			<%=StringUtils.toHtml(sb.toString())%> <br/>
			<a href="javascript:" class="btn btn-default" onclick="history.go(-1);" class="btn">返回上一页</a> &nbsp;
			<a href="javascript:" class="btn btn-info" onclick="jQuery('.errorMessage').toggle();" class="btn">隐藏详细信息</a>
			<br/> <br/>
		</div>
		<script>try{top.jQuery.jBox.closeTip();}catch(e){}</script>
	</div>
</body>
</html>
<%
