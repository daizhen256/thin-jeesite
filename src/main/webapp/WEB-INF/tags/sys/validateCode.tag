...
<%@ attribute name="imageDivCssStyle" type="java.lang.String" required="false" description="验证码外层div样式"%>
<%@ attribute name="buttonCssStyle" type="java.lang.String" required="false" description="看不清按钮样式"%>
<input type="text" id="${name}" name="${name}" maxlength="5" class="form-control input-lg" style="font-weight:bold;${inputCssStyle}"/>
<div style="${imageDivCssStyle}">
