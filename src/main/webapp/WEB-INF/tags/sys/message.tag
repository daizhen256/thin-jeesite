...
<script type="text/javascript">try{top.jQuery.jBox.closeTip();}catch(e){};</script>
<c:if test="${not empty content}">
	...
	<script type="text/javascript">if(!top.jQuery.jBox.tip.mess){top.jQuery.jBox.tip.mess=1;top.jQuery.jBox.tip("${content}","${ctype}",{persistent:true,opacity:0});$("#messageBox").show();}</script>
</c:if>